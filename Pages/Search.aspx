...
<asp:DropDownList ID="ddlSearchType" runat="server" AutoPostBack="True" CssClass="inputs" DataSourceID="searchTech" DataTextField="Name" DataValueField="Id" style="float: right;">
</asp:DropDownList>
    <div style="float:right;">
        ...
        <asp:Label ID="lblPriceSort" runat="server" Text="Sort by Price"></asp:Label>
        <br /><br />
        <asp:Button ID="btnReset" runat="server" Text="Reset All" OnClick="btnReset_Click" />
        <br />
    </div>
    <br /><br /><br />
    <br /><br /><br />
